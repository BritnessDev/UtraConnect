            ...
            <Container fluid>
                ...
                <Col xs={12} lg={12} xl={12}>
                    ...
                    <Row>
                        <Col xs={12} md={6} xl={4}>
                            <div className="form-group">
                                <Form.Label htmlFor="orderNumber">{getMessage("Order number")}</Form.Label>
                                <Form.Control id="orderNumber" placeholder={getMessage("Enter a order number")} type="text" value={pdfData.workshop?.orderNumber} onChange={onChangeHandler} />
                            </div>
                        </Col>
                        <Col xs={12} md={6} xl={4}>
                            <div className="form-group">
