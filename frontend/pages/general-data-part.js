        ...
        <Row>
            {/* <h3 htmlFor="license-accident" className="mb-4 mt-3 text-info">{getMessage('licence_plate_and_vehicle_model')}</h3> */}
                ...
                <Row>
                    <Col xs={12} md={6} xl={4}>
                        <div className="form-group">
                            <Form.Label htmlFor="license">{getMessage('license_plate')}</Form.Label>
                            <Form.Control id="license" placeholder={getMessage('enter_license_plate')} type="text" value={pdfData.general?.license} onChange={onChangeHandler} />
                        </div>
                    </Col>
                    <Col xs={12} md={6} xl={4}>
                        <div className="form-group">
